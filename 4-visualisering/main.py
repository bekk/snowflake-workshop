...
SELECT TPK.*, ST_ASGEOJSON(ST_GEOMETRYFROMWKB(K.GEOMETRY)) AS GEOMETRY
FROM TILSYNSKARAKTER_PER_KOMMUNE AS TPK 
JOIN KOMMUNER_TRANSFORMERT AS K 
ON TPK.KOMMUNENUMMER = K.KOMMUNENUMMER;
""")
